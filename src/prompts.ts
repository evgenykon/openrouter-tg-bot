...
export const CONTEXT_MERGE_SYSTEM =
  ...
  'На входе — текущий блок контекста и сводка нового дня. Обнови блок, включив новый день. ' +
  'Структура блока: для каждой темы отдельный раздел с названием, затем позиции сторон ' +
  '(что каждый участник думает, чувствует и хочет), затем тезисы по теме. ' +
...
export const CONTEXT_CONSOLIDATE_SYSTEM =
  'Сожми блок долгосрочного контекста переписки, сохранив его структуру: темы, позиции сторон, ' +
  'тезисы и абзацы мыслей и выводов. Ничего важного не теряй, объединяй повторы. ' +
  PLAIN_TEXT_RULES
